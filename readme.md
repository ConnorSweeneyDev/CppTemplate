...
will need Python3 for parallel build support - `winget install --id Python.Python.3.10`, pwsh for
the batch files - `winget install --id Microsoft.Powershell --source winget` and Make to build the
executable - `winget install make --source winget`.
